...
public class ConfirmDiscardButton extends Actor {

    private Logger logger = LoggerFactory.getLogger(ConfirmDiscardButton.class);
    ...
    public ConfirmDiscardButton(
        ...
        outlinedButtonTexture = ForbiddenIsland.assetManager.get("custom-ui/discard-button/Discard-Button.png", Texture.class);
        hoverButtonTexture = ForbiddenIsland.assetManager.get("custom-ui/discard-button/Discard-Button-Hovered.png", Texture.class);
        focusedButtonTexture = ForbiddenIsland.assetManager.get("custom-ui/discard-button/Discard-Button-Pressed.png", Texture.class);
