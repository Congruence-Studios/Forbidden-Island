...
public class PlayerHand extends Actor {
    ...
    public PlayerHand(
        ...
        this.width = width;
        this.height = height;
        outlinedButtonTexture = ForbiddenIsland.assetManager.get("./desktop/assets/custom-ui/player-hand/Player-Hand-Button.png", Texture.class);
        hoverButtonTexture = ForbiddenIsland.assetManager.get("./desktop/assets/custom-ui/player-hand/Player-Hand-Button-Hovered.png", Texture.class);
        focusedButtonTexture = ForbiddenIsland.assetManager.get("./desktop/assets/custom-ui/player-hand/Player-Hand-Button-Pressed.png", Texture.class);
