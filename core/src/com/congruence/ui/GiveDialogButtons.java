...
public class GiveDialogButtons extends Actor {

    private Logger logger = LoggerFactory.getLogger(GiveDialogButtons.class);
    ...
    public GiveDialogButtons(
        ...
        outlinedButtonTexture = ForbiddenIsland.assetManager.get("custom-ui/give-dialog-buttons/"+name+" Button.png", Texture.class);
        hoverButtonTexture = ForbiddenIsland.assetManager.get("custom-ui/give-dialog-buttons/"+name+" Button Hovered.png", Texture.class);
        focusedButtonTexture = ForbiddenIsland.assetManager.get("custom-ui/give-dialog-buttons/"+name+" Button Pressed.png", Texture.class);
