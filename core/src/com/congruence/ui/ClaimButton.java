...
public class ClaimButton extends Actor {

    private Logger logger = LoggerFactory.getLogger(ClaimButton.class);
    ...
    private Texture claimedButtonTexture;
    ...
    public ClaimButton(
        ...
        outlinedButtonTexture = ForbiddenIsland.assetManager.get("custom-ui/claim-button/Claim-Button.png", Texture.class);
        hoverButtonTexture = ForbiddenIsland.assetManager.get("custom-ui/claim-button/Claim-Button Hover.png", Texture.class);
        focusedButtonTexture = ForbiddenIsland.assetManager.get("custom-ui/claim-button/Claim-Button Pressed.png", Texture.class);
        claimedButtonTexture = ForbiddenIsland.assetManager.get("custom-ui/claim-button/Claimed-Button.png");
        ...
        claimedButtonTexture.setFilter(Texture.TextureFilter.MipMapLinearLinear, Texture.TextureFilter.MipMapLinearLinear);
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        if (claimed){
            batch.draw(claimedButtonTexture, positionX, positiveY, width, height);
        }
        else if (focused) {
