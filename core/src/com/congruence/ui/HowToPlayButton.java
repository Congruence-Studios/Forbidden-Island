...
public class HowToPlayButton extends Actor {
    ...
    private Logger logger = LoggerFactory.getLogger(HowToPlayButton.class);
    ...
    public HowToPlayButton(
        ...
        outlinedButtonTexture = new Texture(Gdx.files.internal("./start/how-to-button/How-To-Button.png"), true);
        hoverButtonTexture = new Texture(Gdx.files.internal("./start/how-to-button/How-To-Button Hover.png"), true);
        focusedButtonTexture = new Texture(Gdx.files.internal("./start/how-to-button/How-To-Button Pressed.png"), true);
